...
namespace VSCode_in_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Code_in.VSCode_in.GuidList.guidVSCode_inCmdSet, (int)Code_in.VSCode_in.PkgCmdIDList.cmdidOpenFile);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VSCode_in", "Code_in.VSCode_in.VSCode_inPackage");
