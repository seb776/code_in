...
namespace VSCode_in_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void InitializeMenuCommand()
        {
            ...
            CommandID menuCommandID = new CommandID(Code_in.VSCode_in.GuidList.guidVSCode_inCmdSet, (int)Code_in.VSCode_in.PkgCmdIDList.cmdidOpenFile);
