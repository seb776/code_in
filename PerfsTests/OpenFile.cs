...
namespace PerfsTests
{
    ...
    public class OpenFile
    {
        ...
        {
            DeclarationsNodalView declNodalView = new DeclarationsNodalView(code_in.Code_inApplication.MainResourceDictionary);
            ...
            code_in.Views.NodalView.NodalViewActions.AttachNodalViewAndPresenter(declNodalView, nodalPres);
            ...
            _elapsedTime.Start();
            declNodalView.OpenFile(_dialog.FileName);
            _elapsedTime.Stop();
